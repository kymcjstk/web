...
<%@page import="com.b2b.inipay.utll.SignatureUtil"%>
...
<%
	...
	*/
	...
	String price					= "1";													// 상품가격(특수기호 제외, 가맹점에서 직접 설정)
	...
	/* 기타 */
	String siteDomain = "http://localhost:8090/b2b_web/payment"; //가맹점 도메인 입력
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" style="padding:20px">
					...
					<tr>
						<td>
                            ...
                            <input  style="width:100%;" name="returnUrl" value="<%=siteDomain%>/INIStdPayRelay" >
												-->
